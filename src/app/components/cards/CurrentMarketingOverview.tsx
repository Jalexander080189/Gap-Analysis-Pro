...
const CurrentMarketingOverview: React.FC<CurrentMarketingOverviewProps> = ({ 
  ...
  useEffect(() => {
    try {
      ...
      // Formula: (Annual Revenue * 8% / 12) - Total Monthly Spend
      ...
      console.error('Error in Current Marketing Overview calculations:', error);
    }
    ...
    <div className="card">
      {!data.showBack ? (
        ...
        <div className="card-back">
          <h2 className="section-title">Marketing Budget Analysis</h2>
